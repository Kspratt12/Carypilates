...
const classes = [
  {
    ...
    description:
      "Join our small group Pilates classes, designed for just 5 participants to ensure personalized attention and a strong sense of community. Using Balanced Body Pilates reformers, chairs, towers, and other premium equipment.",
    image:
  ...
  },
  {
    ...
    level: "Personalized",
    duration: "50 min",
    cta: "New Client Intro - $60 Session",
...
export default function Classes() {
  ...
  return (
    <section id="classes" className="py-24 md:py-32 bg-[#faf8fb]" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 flex gap-2">
                  <span
                    className="bg-white/90 backdrop-blur-sm text-[#1d1d22] px-3 py-1 rounded-full text-xs font-medium"
                    style={{ fontFamily: "var(--font-inter)" }}
                  >
                    {cls.level}
                  </span>
                  <span
                    className="bg-[#8b7093]/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium"
                    style={{ fontFamily: "var(--font-inter)" }}
                  >
                    {cls.duration}
                  </span>
              ...
              <div className="p-8">
                ...
                <p
                  className="text-[#6c6c89] leading-relaxed mb-6"
                  style={{ fontFamily: "var(--font-inter)" }}
                >
                  {cls.description}
                </p>
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#8b7093] text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-[#7a6082] transition-all duration-300 hover:shadow-lg"
                  style={{ fontFamily: "var(--font-inter)" }}
                >
                  {cls.cta}
        ...
        >
          {features.map((f, i) => (
            ...
            >
              <div className="w-14 h-14 bg-[#faf8fb] rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-[#8b7093]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <h4 className="text-lg font-medium text-[#1d1d22] mb-2">{f.title}</h4>
