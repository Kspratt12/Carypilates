...
export default function Classes() {
  ...
  return (
    <section id="classes" className="py-32 md:py-40 bg-[#faf8fb]" ref={ref}>
          ...
          {classes.map((cls, i) => (
            ...
            >
              ...
              <div className="p-8 pb-10">
                <h3 className="text-2xl font-light text-[#1d1d22] mb-5">
                  {cls.title}
                </h3>
                <p
                  className="text-[#6c6c89] text-sm mb-8"
                  style={{ fontFamily: "var(--font-inter)", lineHeight: 2 }}
                >
                  {cls.description}
                </p>
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#8b7093] text-white px-7 py-3.5 rounded-full text-sm font-semibold hover:bg-[#7a6082] transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
                  style={{ fontFamily: "var(--font-inter)" }}
                >
                  {cls.cta}
