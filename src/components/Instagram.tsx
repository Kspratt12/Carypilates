      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16">
            ...
            >
              ...
              >
                <a
                  ...
                  className="block p-8 text-center text-sm text-[#8b7093]"
                >
                  View on Instagram
                </a>
              </blockquote>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 border border-gray-900 text-gray-900 text-[13px] tracking-widest uppercase hover:bg-gray-900 hover:text-white transition-all duration-300"
          >
