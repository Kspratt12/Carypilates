    ...
    <footer className="bg-[#1a1a1a] text-white py-20">
      <div className="max-w-6xl mx-auto px-6 md:px-16">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs tracking-[0.3em] uppercase text-[#c9b5d0] mb-6">
              Quick Links
            </h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-white/50 hover:text-[#c9b5d0] transition-colors text-[15px]"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <ul className="space-y-4 text-white/50 text-[15px]">
              ...
              <li>
                <a
                  ...
                  className="hover:text-[#c9b5d0] transition-colors"
                >
